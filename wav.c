...
// Openning a new file and populating it with WAV header
...
//Do the output of the contents of a WAV file to my disk
...
// Update the WAV file header and close that file
...
// Allocating memory for an empty song, setting initial capacity up to 16 notes
...
{
    // Increase size of song if possible
...
// Adding a frequency of 0 to represent a rest in the song
